...
export const TrophyIcon = () => <Trophy className={sidebarIconClass} />;
...
export const AwardIcon = () => <Award className="w-5 h-5" />;
export const StarIcon = () => <Star className="w-5 h-5" />;
export const ShieldIcon = () => <Shield className="w-5 h-5" />;
export const GemIcon = () => <Gem className="w-5 h-5" />;
